  ...
  return (
    <Container>
      <div className="container w-full mt-20">
        ...
        <div className="">
          <p className="mb-4 text-base">Last updated October 10, 2023</p>
          <p className="mb-4 text-base">AGREEMENT TO OUR LEGAL TERMS</p>
          <p className="mb-4 text-base">
            We are CLOUT ("Company," "we," "us," "our"), a company registered in
            Kazakhstan at STREET SADIK DUYSEBAEVA, Shymkent, Turkestan 160900.
          </p>
          <p className="mb-4 text-base">
            We operate the website{" "}
            <a href="http://www.clout.kz">http://www.clout.kz</a> (the "Site"),
          ...
          <p className="mb-4 text-base">
            You can contact us by phone at +7 747 473 3775, email at{" "}
            <a href="mailto:info@clout.kz">info@clout.kz</a>, or by mail to
            STREET SADIK DUYSEBAEVA, Shymkent, Turkestan 160900, Kazakhstan.
          </p>
          <p className="mb-4 text-base">
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and CLOUT, concerning your access to and use of the Services. You
          ...
          <p className="mb-4 text-base">
            ...
            <a href="mailto:info@clout.kz">info@clout.kz</a>, as stated in the
          ...
          <p className="mb-4 text-base">TABLE OF CONTENTS</p>
          <p className="mb-4 text-base">1. OUR SERVICES</p>
          <p className="mb-4 text-base">2. INTELLECTUAL PROPERTY RIGHTS</p>
          <p className="mb-4 text-base">3. USER REPRESENTATIONS</p>
          <p className="mb-4 text-base">4. USER REGISTRATION</p>
          <p className="mb-4 text-base">5. PURCHASES AND PAYMENT</p>
          <p className="mb-4 text-base">6. FREE TRIAL</p>
          <p className="mb-4 text-base">7. CANCELLATION</p>
          <p className="mb-4 text-base">8. PROHIBITED ACTIVITIES</p>
          <p className="mb-4 text-base">9. USER GENERATED CONTRIBUTIONS</p>
          <p className="mb-4 text-base">10. CONTRIBUTION LICENSE</p>
          <p className="mb-4 text-base">11. GUIDELINES FOR REVIEWS</p>
          <p className="mb-4 text-base">12. SOCIAL MEDIA</p>
          <p className="mb-4 text-base">13. THIRD-PARTY WEBSITES AND CONTENT</p>
          <p className="mb-4 text-base">14. SERVICES MANAGEMENT</p>
          <p className="mb-4 text-base">15. PRIVACY POLICY</p>
          <p className="mb-4 text-base">16. COPYRIGHT INFRINGEMENTS</p>
          <p className="mb-4 text-base">17. TERM AND TERMINATION</p>
          <p className="mb-4 text-base">18. MODIFICATIONS AND INTERRUPTIONS</p>
          <p className="mb-4 text-base">19. GOVERNING LAW</p>
          <p className="mb-4 text-base">20. DISPUTE RESOLUTION</p>
          <p className="mb-4 text-base">21. CORRECTIONS</p>
          <p className="mb-4 text-base">22. DISCLAIMER</p>
          <p className="mb-4 text-base">23. LIMITATIONS OF LIABILITY</p>
          <p className="mb-4 text-base">24. INDEMNIFICATION</p>
          <p className="mb-4 text-base">25. USER DATA</p>
          <p className="mb-4 text-base">
            26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </p>
          <p className="mb-4 text-base">27. MISCELLANEOUS</p>
          <p className="mb-4 text-base">28. CONTACT US</p>
          <p className="mb-4 text-base">1. OUR SERVICES</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">2. INTELLECTUAL PROPERTY RIGHTS</p>
          <p className="mb-4 text-base">Our intellectual property</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">Your use of our Services</p>
          <p className="mb-4 text-base">
            Subject to your compliance with these Legal Terms, including the
            "PROHIBITED ACTIVITIES" section below, we grant you a non-exclusive,
            non-transferable, revocable license to:
          </p>
          <p className="mb-4 text-base">- access the Services; and</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">
            ...
            <a href="mailto:info@clout.kz">info@clout.kz</a>. If we ever grant
          ...
          <p className="mb-4 text-base">Your submissions and contributions</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">Copyright infringement</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">- Visa</p>
          <p className="mb-4 text-base">- Mastercard</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">
            ...
            <a href="mailto:info@clout.kz">info@clout.kz</a> or call us at +7
            747 473 3775.
          </p>
          <p className="mb-4 text-base">8. PROHIBITED ACTIVITIES</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">
            ...
            the Services. Please note that if a Third-Party Account or
          ...
          <p className="mb-4 text-base">
            ...
            Policy:{" "}
            <a href="http://www.clout.kz/privacy_policy.html">
              http://www.clout.kz/privacy_policy.html
            </a>
            . By using the Services, you agree to be bound by our Privacy
            Policy, which is incorporated into these Legal Terms. Please be
            advised the Services are hosted in Kazakhstan. If you access the
            ...
            that differ from applicable laws in Kazakhstan, then through your
            continued use of the Services, you are transferring your data to
            Kazakhstan, and you expressly consent to have your data transferred
            to and processed in Kazakhstan.
          </p>
          <p className="mb-4 text-base">16. COPYRIGHT INFRINGEMENTS</p>
          <p className="mb-4 text-base">
            We respect the intellectual property rights of others. If you
          ...
          <p className="mb-4 text-base">
            ...
            laws of Kazakhstan. CLOUT and yourself irrevocably consent that the
            courts of Kazakhstan shall have exclusive jurisdiction to resolve
          ...
          <p className="mb-4 text-base">
            ...
            the jurisdiction of the Kazakhstan courts. CLOUT shall also maintain
          ...
          <p className="mb-4 text-base">
            ...
            ARISING OR $100.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS
          ...
          <p className="mb-4 text-base">(1) your Contributions;</p>
          <p className="mb-4 text-base">(2) use of the Services;</p>
          <p className="mb-4 text-base">(3) breach of these Legal Terms;</p>
          <p className="mb-4 text-base">
          ...
          <p className="mb-4 text-base">
            ...
            RECORDS OF TRANSACTIONS INITIATED OR COMPLÈTED BY US OR VIA THE
          ...
          <p className="mb-4 text-base">
            ...
            delay, or failure to act carised by any cause beyond our reasonable
          ...
          <p className="mb-4 text-base">CLOUT</p>
          <p className="mb-4 text-base">STREET SADIK DUYSEBAEVA</p>
          <p className="mb-4 text-base">Shymkent, Turkestan 160900</p>
          <p className="mb-4 text-base">Kazakhstan</p>
          <p className="mb-4 text-base">Phone: +7 747 473 3775</p>
          <p className="mb-4 text-base">info@clout.kz</p>
          <p className="mb-4 text-base">
